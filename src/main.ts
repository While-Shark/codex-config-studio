...
<main class="content">
<section class="scope-panel card"><div class="section-heading"><div><span class="eyebrow">01 / 作用域</span><h2>这次配置应用在哪里？</h2></div><div class="segmented"><button class="scope-tab active" data-scope="global">全局</button><button class="scope-tab" data-scope="project">项目</button></div></div><div class="scope-body"><div><div class="scope-title" id="scopeTitle">全局配置</div><div class="path" id="configPath">~/.codex/config.toml</div></div><div id="projectPicker" class="project-picker hidden"><input id="projectPath" placeholder="选择项目根目录，例如 E:\\java\\my-project"><button id="chooseProject" class="button secondary">选择目录</button></div></div><div id="projectNotice" class="notice hidden">项目配置优先于 Profile 和全局配置，但 Codex 只会加载受信任项目的 <code>.codex/config.toml</code>。</div></section>
...
function requestScope(){return {kind:scope,projectPath:scope==='project'?(projectPath||null):null}}\nfunction projectConfigDisplayPath(){if(!projectPath)return '请选择项目目录';const clean=projectPath.replace(/[\\\\\\/]$/,'');const sep=clean.includes('\\\\')?'\\\\':'/';return `${clean}${sep}.codex${sep}config.toml`}
